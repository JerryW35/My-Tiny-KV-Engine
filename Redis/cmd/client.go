...
type cmdHandler func(cli *myClient, args [][]byte) (interface{}, error)
...
func execClientCommand(conn redcon.Conn, cmd redcon.Command) {
	...
	client, _ := conn.Context().(*myClient)
	switch command {
	case "quit":
		_ = conn.Close()
	case "ping":
...
func set(cli *myClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
...
func get(cli *myClient, args [][]byte) (interface{}, error) {
	if len(args) != 1 {
...
func hset(cli *myClient, args [][]byte) (interface{}, error) {
	if len(args) != 3 {
...
func sadd(cli *myClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
...
func lpush(cli *myClient, args [][]byte) (interface{}, error) {
	if len(args) != 2 {
...
func zadd(cli *myClient, args [][]byte) (interface{}, error) {
	if len(args) != 3 {
